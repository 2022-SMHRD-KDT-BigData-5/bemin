			...
			<div id="sectionD">
				...
				<div class="wtgTool">
					...
					<p id="toggleMap" onclick="showmap()" class="txt1"
						style="text-decoration: underline;">지도 보기</p>
					<br>
				</div>
				<div class="match-info__fee">
					<div class="matchFee">
						<div>
							<span class="matchFee__money">n원</span> <span> / n시간</span>
						</div>
						<br>
					</div>
					<div class="joinD">
