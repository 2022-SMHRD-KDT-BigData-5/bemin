    ...
    <body data-spy="scroll" data-target=".navbar-collapse">
                ...
                <!-- <div class="main-logo2" >
                   <a class="navbar-brand" href="메인.html">
                            <img src="assets/images/g-logo2.png" class="logo" alt="" >
                        </a>
                    </div> -->
                            ...
                            <div class="recipt"><!----> 
                                <p class="list_menu">
                                    ...
                                    <div class="list-right">
                                        <h5>0원 사용</h5> 
                                        <img src="https://plab-football.s3.amazonaws.com/static/img/ic_arrow_right.svg">
                                    </div>
                                </p> 
                                <div style="text-align: right; padding-bottom: 20px;">
                                    <span style="color: rgb(159, 177, 189); font-size: 12px;">잔액 0원</span>
                                </div>
                            </div>
                        </div>
                    </section>
                                     ...
                                     <div class="section_title_1">
                                        ...
                                        <div class="section_body">
                                            <div class="list">
                                                <ul>
                                                    <li class="list_radio">
                                                        <input type="radio" id="HjPay" value="" name="HjPay"> 
                                                        <label for="kakaoPay">
                                                            <span>
                                                                <p id="payM">계좌이체</p>                                                
                                                            </span> 
                                                         ...
                                                         <ul><!---->
                                                            <li class="accordion_item">
                                                                ...
                                                                <div style="text-align: left;">
                                                                    <p>
                                                                        "운동화(실내화) 이외에는 어떠한 신발(구두, 캐주얼화, 작업화 등)도 착용을 금합니다.
                                                                        (체육관 바닥의 손상과 부상의 위험이 있습니다.)"
                                                                        <br>
                                                                        <br>
                                                                        "절대 금연 및 금주, 취사 취식 불가입니다.
                                                                        (간단한 음료는 가능합니다. 쓰레기가 방치되지 않도록 주의해주세요.)"
                                                                        <br>
                                                                        <br>
                                                                        "어린이 동행 시는 부모가 안전사고외 모든 것을 책임집니다."
                                                                        <br>
                                                                        <br>
                                                                        "시설 내에 동물 동반을 절대 금합니다."
                                                                        <br>
                                                                        <br>
                                                                        "체육관 바닥 유지관리 및 보존에 의무를 다합니다.
                                                                        (라인 생성은 자제해주세요.)"
                                                                        <br>
                                                                        <br>
                                                                        "이용자의 부주의로 시설을 파손하면, 손해배상을 청구할 수 있습니다. 이 점 유의해 주세요."
                                                                    </p>
                                                            ...
                                                            <li class="accordion_item">
                                                                <div class="accordion-item_title">
                                                                    ...
                                                                    <div>
                                                                        <p style="text-align: left;">
                                                                            "매치 당일 3일(72시간) 전까지 100% 환불이 가능합니다.
                                                                            (이후 매치 당일 24시간 전까지 50% 환불)"
                                                                            <br>     
                                                                            <br>
                                                                            "당일 환불은 불가능합니다.
                                                                            (단, 시설 문제로 인한 이용이 불가능 할 시 100% 환불)"
                                                                            <br>     
                                                                            <br>
                                                                        </p>
                                                                    </div> <!---->
                                                                ...
                                                                <li class="accordion_item">
                                                                    <div class="accordion-item_title">
                                                                        <h3>⭐플라이트는 바른 생활체육 문화를 지양합니다.⭐
                                                                            <br>
                                                                            항상 다른 이용자들을 배려하는 플레이를 권장드리며, 부상의 위험 없이 즐거운 이용 부탁드려요.</h3> 
